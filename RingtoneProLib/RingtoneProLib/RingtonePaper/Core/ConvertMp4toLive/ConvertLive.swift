...
class ConvertLive {
    ...
    public class func generate(videoURL: URL, progress: @escaping (CGFloat) -> Void, completion: @escaping (PHLivePhoto?, LivePhotoResources?) -> Void) {
        queue.async {
            shared.generate(videoURL: videoURL, progress: progress, completion: completion)
        }
    }
    ...
    // MARK: PRIVATE
    private static let shared = ConvertLive()
    ...
    private func generate(videoURL: URL, progress: @escaping (CGFloat) -> Void, completion: @escaping (PHLivePhoto?, LivePhotoResources?) -> Void) {

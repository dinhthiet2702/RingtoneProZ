...
public final class AudioSetupContex {
    ...
    public static func load(fromAudioURL audioURL: URL, completionHandler: @escaping (_ audioContext: AudioSetupContex?) -> ()) {
        ...
        asset.loadValuesAsynchronously(forKeys: ["duration"]) {
            ...
            case .loaded:
                ...
                let audioContext = AudioSetupContex(audioURL: audioURL, totalSamples: totalSamples, asset: asset, assetTrack: assetTrack)
                completionHandler(audioContext)
            case .failed, .cancelled, .loading, .unknown:
//                Log.e("Couldn't load asset: \(error?.localizedDescription ?? "Unknown error")")
                completionHandler(nil)
            @unknown default:
//                Log.e("Couldn't load asset, unknown default: \(error?.localizedDescription ?? "Unknown error")")
                completionHandler(nil)
            }
        }
    }
